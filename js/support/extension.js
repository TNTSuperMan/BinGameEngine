...
class CompletionItemProvider{
    provideCompletionItems(document, position, token){
        ...
        return Promise.resolve(new vscode.CompletionList([
            ...
            {label: "pls", kind: vscode.CompletionItemKind.Method},
            ...
            {label: "sin", kind: vscode.CompletionItemKind.Method},
            {label: "sqrt", kind: vscode.CompletionItemKind.Method},
            ...
            {label: "pixel", kind: vscode.CompletionItemKind.Method},
            {label: "rect", kind: vscode.CompletionItemKind.Method},
            {label: "chkkey", kind: vscode.CompletionItemKind.Method}
        ],false))
    }
}
